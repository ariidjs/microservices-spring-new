...
docker pull ariidjs/new-api-gateway:latest
docker pull ariidjs/new-product-service:latest
docker pull ariidjs/new-order-service:latest
docker pull ariidjs/new-inventory-service:latest
docker pull ariidjs/new-notification-service:latest
...
kind load docker-image -n microservices ariidjs/new-api-gateway:latest
kind load docker-image -n microservices ariidjs/new-product-service:latest
kind load docker-image -n microservices ariidjs/new-order-service:latest
kind load docker-image -n microservices ariidjs/new-inventory-service:latest
kind load docker-image -n microservices ariidjs/new-notification-service:latest
